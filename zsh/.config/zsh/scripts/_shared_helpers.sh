...
# _shared_rule
# -----------------------------------------------------------------------------
# Prints a horizontal rule sized for the current terminal.
# -----------------------------------------------------------------------------
_shared_rule() {
  local char="${1:--}"
...
# _shared_banner
# -----------------------------------------------------------------------------
# Prints a banner-like title block for interactive commands.
# -----------------------------------------------------------------------------
_shared_banner() {
  local title="$1"
  local subtitle="${2:-}"
...
# _shared_section
# -----------------------------------------------------------------------------
# Prints a compact section label for interactive command output.
# -----------------------------------------------------------------------------
_shared_section() {
  local title="$1"
  printf "%s%s%s\n" "$C_BOLD" "$title" "$C_RESET"
