...
_vscode_sync_common="${_vscode_sync_module_root}/_common.zsh"
_vscode_sync_cleaner="${_vscode_sync_module_root}/extension-cleaner.zsh"
_vscode_sync_core="${_vscode_sync_module_root}/sync/_core.zsh"
_vscode_sync_ext="${_vscode_sync_module_root}/sync/extensions.zsh"
_vscode_sync_cmd="${_vscode_sync_module_root}/sync/commands.zsh"
