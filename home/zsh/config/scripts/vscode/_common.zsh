...
_vscode_shared_helpers="${_vscode_scripts_dir}/_shared-helpers.zsh"
...
# -----------------------------------------------------------------------------
_vscode_python_backend_available() {
  command -v python3 >/dev/null 2>&1 && [[ -r "${_VSCODE_MODULE_ROOT}/python/cli.py" ]]
}
